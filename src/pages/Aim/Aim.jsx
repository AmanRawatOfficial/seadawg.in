    ...
    return (
        <div className="aim">
            <div className="water_mark_container">
                <div className="water_mark_lines line_one"></div>
                <p className="water_mark">sea.dawg.in</p>
                <div className="water_mark_lines line_two"></div>
            </div>
                ...
                <div className="content">
                    <p>
                        ...
                        <div className="content_second">
                            It is not only that one of the largest workforces on
                            earth, moving 90% of the world’s goods was neglected
                            as a market for merchandise made specifically for
                            them. We feel the pain of our brethren being
                            neglected on a lot of fronts.
                            <br />
                            <br />
